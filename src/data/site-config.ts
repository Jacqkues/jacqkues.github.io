...
const siteConfig: SiteConfig = {
    ...
    hero: {
      ...
      /*  image:{
        ...
        text:"I'm **Jacques Dumora**, a Machine Learning Engineer based in Paris, France. Passionate about cutting-edge technologies and data science, I specialize in crafting innovative and efficient solutions to tackle both today's challenges and those of the future.\n\n Whether it's **machine learning**, **data modeling**,**software engineering** or **AI-driven systems**, my goal is to merge **technical excellence** with **elegant design** to provide real value. \n \n Feel free to explore some of my coding endeavors on <a href='https://github.com/Jacqkues'>GitHub</a> or follow me on <a href='https://x.com/_jacqD'>Twitter/X</a>.",
